...
import { getProduct, updateProduct } from '../../../lib/clientStore';
...
export default function EditProduct() {
  ...
  useEffect(() => {
    ...
    if (!product) { router.replace('/admin/products'); return; }
    setForm({
      name: product.name,
  ...
  if (!form) return <AdminLayout title="Edit Product"><div className="text-stone-400">Loading...</div></AdminLayout>;
